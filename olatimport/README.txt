...
D) follow the instructions in step5.txt to generate a html educational page about a topic or the pasted content
E) follow the instructions in stepmindmap.txt to generate a mindmap in html format
F) follow the instructions in step4.txt to generate a h5p Questions about a topic or the pasted content
